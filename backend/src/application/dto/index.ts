export { CreateExerciseDto } from './exercise/create-exercise.dto';
export { GetExerciseDto } from './exercise/get-exercise.dto';
export { DeleteExerciseDto } from './exercise/delete-exercise.dto';
export { UpdateExerciseDto } from './exercise/update-exercise.dto';
